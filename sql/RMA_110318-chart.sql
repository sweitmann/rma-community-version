...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('1170','Vorsteuer 8.0% auf Mat. + DL','A','A','AP_tax','117',false,true,'');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('1172','Vorsteuer 2.5% auf Mat. + DL','A','A','AP_tax','117',false,true,'');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('1173','Vorsteuer 8.0% auf Inv. + übr. BA','A','A','AP_tax','117',false,true,'');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('1174','Vorsteuer 3.8% auf Inv. + übr. BA','A','A','AP_tax','117',false,true,'');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('1175','Vorsteuer 2.5% auf Inv. + übr. BA','A','A','AP_tax','117',false,true,'');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('1176','Vorsteuer 8,0% Bezugsteuer','A','A','AP_tax','117',false,true,'');
...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('18','NICHT EINBEZAHLTES GRUNDKAPITAL','H','A','','180',false,true,'');
...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('2201','MWST 8,0%','A','L','AR_tax:IC_taxpart:IC_taxservice','220',false,true,'');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('2202','MWST 3,8%','A','L','','220',false,true,'');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('2203','MWST 2,5%','A','L','','220',false,true,'');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('2204','Bezugsteuer 8,0%','A','L','AP_tax','220',false,true,'');
...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('280','KAPITAL','H','Q','','280',false,true,'');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('2800','Kapital','A','Q','','280',false,true,'');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('290','RESERVEN UND JAHRESGEWINN ODER JAHRESVERLUST','H','Q','','290',false,true,'');
...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('2950','Gesetzliche Gewinnreserve','A','Q','','290',false,true,'');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('2960','Andere Reserven','A','Q','','290',false,true,'');
